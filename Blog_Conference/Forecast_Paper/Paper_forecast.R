...
m3_data<- subset(m3_data, Category=="MICRO       " )
...
write.csv(all_series_forecast,"C:/Work/Forecasting/Forecast_Paper/forecast_result_micro.csv", row.names = FALSE)


forecast_900<-read.csv("C:\\Work\\Forecasting\\Forecast_Paper\\forecast_result_900_1100.csv",stringsAsFactors = FALSE)
forecast_1100<-read.csv("C:\\Work\\Forecasting\\Forecast_Paper\\forecast_result_1101_1300.csv",stringsAsFactors = FALSE)
forecast_1300<-read.csv("C:\\Work\\Forecasting\\Forecast_Paper\\forecast_result_1301_last.csv",stringsAsFactors = FALSE)

result1<-read.csv("C:\\Work\\Forecasting\\Forecast_Paper\\forecast_result_micro.csv",stringsAsFactors = FALSE) 
result2<-read.csv("C:\\Work\\Forecasting\\Forecast_Paper\\forecast_result_industry.csv",stringsAsFactors = FALSE) 
result3<-read.csv("C:\\Work\\Forecasting\\Forecast_Paper\\forecast_result_macro.csv",stringsAsFactors = FALSE) 
result4<-read.csv("C:\\Work\\Forecasting\\Forecast_Paper\\forecast_result_finance.csv",stringsAsFactors = FALSE) 
result5<-read.csv("C:\\Work\\Forecasting\\Forecast_Paper\\forecast_result_demographic.csv",stringsAsFactors = FALSE) 
result6<-read.csv("C:\\Work\\Forecasting\\Forecast_Paper\\forecast_result_others.csv",stringsAsFactors = FALSE) 


all_series_forecast<-rbind(result1,result2,result3,result4,result5,result6)
...
write.csv( all_series_forecast1,"C:/Work/Forecasting/Forecast_Paper/forecast_result1.csv", row.names = FALSE)
