...
void 0!==c.vtp_forceSsl&&c.vtp_forceSsl&&(u.push(["_gat._forceSSL"]),v=!!c.vtp_forceSsl);d("_set","hitCallback",function(){ma(c.vtp_hitCallback)&&c.vtp_hitCallback();c.vtp_gtmOnSuccess()});if("TRACK_EVENT"==c.vtp_trackType){d("_trackEvent",String(c.vtp_eventCategory),String(c.vtp_eventAction),
